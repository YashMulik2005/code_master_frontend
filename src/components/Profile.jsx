...
function Profile() {
  ...
  const getdata = async () => {
    ...
    setsearch("");
    if (id == undefined) {
      const result = await axios.post(`${url}/user/profile`, {
  ...
  return (
    <div onClick={handlenav} className=" h-[95vh]">
          ...
          <section className=" relative w-[100%]">
            <form action="" onSubmit={handlesearch} className=" w-[100%]">
              <input
                ...
                className={`${
                  theme == "dark"
                    ? "border-none focus:outline-none bg-[#0c131d]"
                    : "border-2"
            ...
            <section
              className={` overflow-y-auto p-3 ${
                searchbox == true ? "block" : "hidden"
              } z-10 ${
                theme == "light" ? "bg-[#f5f1f0]" : "bg-[#0c131d]"
              } absolute max-h-48 w-[100%] top-12 rounded-md`}
            >
      ...
      {loading ? (
        ...
        user?.map((item, index) => {
          return (
            <div className=" relative flex flex-col min-[950px]:flex-row min-[950px]:h-[87vh] p-4 sm:p-5 justify-center">
              <div
                className={`${
                  theme == "light" ? "bg-[#f5f1f0] " : "bg-[#0c131d]"
                }  h-[100%] w-[100%] min-[950px]:w-[30%] rounded-xl flex items-center p-5 mb-4 min-[950px]:mb-0 flex-col`}
              >
                ...
                <button
                  className={` ${
                    contextusername == item.username ? "block" : "hidden"
                  } w-[80%] px-3 py-1 bg-green-600 text-white rounded-3xl font-bold text-lg my-3 `}
                ...
                <section
                  className={` ${
                    theme == "dark" ? "bg-[#1c232b]" : "bg-white"
                  } w-[95%] rounded-3xl pl-4 py-[7px]  my-1`}
                >
                  <h1 className="text-sm text-[#a19999] font-semibold">
                    First Name:
                  </h1>
                  <h1
              ...
              <div className=" w-[100%] min-[950px]:w-[70%] h-[100%] ">
                <div className="w-[100%] flex min-[950px]:flex-row flex-col min-[950px]:h-[27%] min-[950px]:ml-4">
                  <div
                    className={`${
                      theme == "dark" ? " bg-[#0c131d]" : "bg-[#f5f1f0]"
                    } w-[100%] min-[950px]:w-[40%] h-32 min-[950px]:my-0 my-4 rounded-lg mr-3 flex`}
                  >
                ...
                <div
                  className={` ${
                    theme == "dark" ? "bg-[#0c131d]" : "bg-[#f5f1f0]"
                  }  w-[100%] sm:w-[96%] sm:h-[70%]  sm:mx-5 rounded-lg my-5 p-2 sm:p-5 overflow-y-auto `}
                >
                  <h1
                  ...
                  <div className=" flex flex-col items-center my-2 ">
                    {que.length == 0 ? (
                      <div
                        className={` ${
                          theme == "dark" ? " bg-[#1c232b]" : "bg-white"
                        } w-[90%] rounded-xl p-[10px] my-[7px] text-center `}
                      >
                        <h1 className=" text-md font-bold">
                          You hasn't post any question.
                        </h1>
                      </div>
                    ) : (
                      que?.map((item, index) => {
                        return (
                          <section
                            className={` ${
                              theme == "dark" ? " bg-[#1c232b]" : "bg-white"
                            } w-[90%] rounded-3xl py-[7px] my-[7px] `}
                          >
              ...
              <div
                className={` ${
                  searchbox == true ? "block" : "hidden"
                } absolute m-0 left-0 top-0 h-[100%] min-[950px]:h-[90vh] w-[100%] ${
                  theme == "light" ? " bg-gray-400/30" : " bg-black/70"
                } backdrop:md  `}
              ></div>
            </div>
          );
