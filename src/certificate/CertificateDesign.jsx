  ...
  return (
    <div className="">
      <div className=" hidden p-2 px-4 sm:flex justify-between items-center shadow-md">
        ...
        <section className=" cursor-pointer" onClick={handletheme}>
          {theme == "light" ? (
            <MdDarkMode size={27} />
          ) : (
      ...
      <div className="p-4 sm:p-9 lg:px-48">
        <div
          className=" p-4 sm:p-6 rounded-md bg-cover bg-no-repeat"
          style={{
        ...
        >
          <div className=" p-4 rounded-md">
            ...
            <h1 className=" text-center text-xl font-extrabold text-black">
              {data[0]?.name}
            </h1>
        ...
        <section className=" my-5 ">
          <section className=" flex justify-between items-center px-3">
            ...
            <button
              onClick={handlecopy}
              className=" bg-green-600 px-2 py-1 text-white rounded-md font-semibold"
            >
              copy link
            </button>
          </section>
          <input
            ref={input}
            type="text"
            className={` my-4 w-full p-2 m-1 rounded-md focus:outline-none ${
              theme == "light" ? "border-2" : "border-1"
            }`}
            defaultValue={`${url}/showceroficate/${id}/${contextusername}`}
          />
        </section>
      </div>
    </div>
