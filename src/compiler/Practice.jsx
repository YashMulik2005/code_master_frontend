                ...
                <div className=' flex min-[800px]:flex-row flex-col w-[100%]'>
                    <div className=' min-[800px]:w-[18%] w-[100%] py-8 px-3 ' >
                        ...
                        <ul className='flex flex-row min-[800px]:flex-col  p-1 sm:lg overflow-x-auto  '>
                            ...
                            <li className={`${topic == "searching" ? `${theme == "light" ? "text-black font-semibold" : "text-white font-semibold"} ` : ""} ${theme == "light" ? "hover:bg-[#f5f1f0]" : "hover:bg-[#0c131d]"} p-1 px-3 rounded-lg cursor-pointer`} onClick={handletopic}>binary search</li>
                            ...
                            <li className={`${topic == "linked list" ? `${theme == "light" ? "text-black font-semibold" : "text-white font-semibold"} ` : ""} ${theme == "light" ? "hover:bg-[#f5f1f0]" : "hover:bg-[#0c131d]"} p-1 px-3 rounded-lg cursor-pointer`} onClick={handletopic}>data structures</li>
                            <li className={`${topic == "stack" ? `${theme == "light" ? "text-black font-semibold" : "text-white font-semibold"} ` : ""} ${theme == "light" ? "hover:bg-[#f5f1f0]" : "hover:bg-[#0c131d]"} p-1 px-3 rounded-lg cursor-pointer`} onClick={handletopic}>observation</li>
