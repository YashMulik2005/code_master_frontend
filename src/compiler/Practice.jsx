...
function Practice() {
  const { topic, settopic, contextusername, logedin, setnavbar, theme } =
    themehook();
        ...
        <div className="max-[666px]:hidden p-1 px-6 flex justify-between items-center py-3 ">
          ...
          {logedin ? (
            <section
              className={` ${
                theme == "light" ? "text-black" : "text-white"
              } flex items-center m-2 cursor-pointer`}
            >
            ...
            <section className=" cursor-pointer">
              <button
                className={` font-bold rounded-3xl border-[1px] px-3 sm:px-5 py-[4px] border-gray-400 hover:bg-[#39a84b] hover:border-[#e9ffed] hover:text-white `}
                onClick={() => {
                  setnavbar(false);
                  naviagte("/auth/login");
                }}
              ...
              <button
                className=" mx-2 font-bold rounded-3xl border-[1px] px-3 sm:px-5 py-[4px] border-gray-400 hover:bg-[#39a84b] hover:border-[#e9ffed] hover:text-white"
                onClick={() => {
                  setnavbar(false);
        ...
        <div className=" flex min-[800px]:flex-row flex-col w-[100%]">
            ...
            <ul className="flex flex-row min-[800px]:flex-col  p-1 sm:lg overflow-x-auto  ">
              <li
                className={`${
                  ...
                  theme == "light" ? "hover:bg-[#f5f1f0]" : "hover:bg-[#0c131d]"
                }  p-1 px-3 rounded-lg cursor-pointer`}
                onClick={handletopic}
              >
                all
              </li>
          ...
          <div className="py-3 sm:p-6 p-2 flex flex-col justify-center h-[88vh] min-[800px]:w-[82%] w-[100%]">
            <div className="flex justify-between items-center mb-4">
              <h1
                className={`${theme == "light" ? "" : "text-white"} font-bold`}
              >
                Questions
              </h1>
                ...
                <input
                  ...
                  className={`${
                    theme == "dark"
                      ...
                      : "bg-[#f5f1f0] border-2"
                  }  px-4 py-[7px] w-[100%] rounded-full focus:outline-none `}
            ...
            <div
              ...
              } h-[100%] overflow-y-auto w-[100%] pb-2 rounded-lg `}
            >
              <table className="border-collapse w-[100%] ">
                <thead>
                  <tr className=" bg-green-600">
                    <th className="p-3 py-3 text-left text-white text-lg">
                      No.
                    </th>
                    <th className="p-3 text-left py-3 text-white text-lg">
                      Name
                    </th>
                    <th className="p-3 text-left py-3 text-white text-lg">
                      Topic
                ...
                {loader ? (
                  ...
                  output?.map((item, index) => {
                    return (
                      <tr className="  border-b border-slate-500" key={index}>
                        <td className=" p-3 font-semibold text-left text-sm">
                          {index + 1}
                        </td>
                        <td className=" p-3 font-semibold text-left text-green-600">
                          <Link to={`/practice/question/${item._id}`}>
                            {item.name}
                          </Link>
                        </td>
                        ...
                        <td className=" p-3 font-semibold text-left">
                          <Link
                            to={`/practice/question/${item._id}`}
                            className="flex items-center"
                          >
                            solve <AiOutlineArrowRight className="" />
                          </Link>
                        </td>
                      </tr>
                    );
