...
function ForumAns() {
  ...
  const handleaddans = async () => {
    ...
    if (result.data.data.success) {
      toast.success("Answer posted sucessfully !!!");
      getans();
    } else {
        ...
        <div className=" max-[775px]:w-[100%] w-[75%] overflow-y-auto h-[90vh]">
          {loading ? (
            ...
            qdata?.map((item, index) => {
              return (
                <div
                  className={`p-5 border-[1px]  m-4 rounded-lg ${
                    theme == "dark"
                      ? "bg-[#0c131d] border-none shadow-md shadow-[#090c10] "
                      : " bg-[#f5f1f0] shadow-md"
                  }`}
                >
                  <section>
            ...
            {log ? (
              ...
              >
                <h1 className=" font-bold text-green-600">
                  login to see answers you posted.
                </h1>
              </div>
            ) : loading2 ? (
              <div>
              ...
              >
                <h1 className=" font-semibold">
                  You hasn't post any answer yet.
                </h1>
              </div>
            ) : (
