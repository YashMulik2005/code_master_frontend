...
function Forum() {
  ...
  const handlesearchchange = async (e) => {
    if (e.target.value.length == 0) getdata();
  ...
  return (
    <div className=" w-full">
      <div
        className=" sm:hidden bg-green-700 p-2  rounded-xl right-2 bottom-4 fixed"
        onClick={() => {
          if (logedin) {
      ...
      <dialog id="my_modal_3" className="modal">
        <form method="dialog" className="modal-box">
          ...
          <div>
            <input
              type="text"
              className={` w-full border-2 p-2 my-2 rounded-lg ${
                theme == "dark"
                  ? "bg-[#0c131d]  focus:outline-none border-none"
                  : "bg-[#f5f1f0]"
              }`}
              value={heading}
              placeholder="heading"
            ...
            ></textarea>
            <button
              className=" font-bold rounded-3xl border-[1px] px-3 sm:px-5 py-[4px] border-gray-400 hover:bg-[#39a84b] hover:border-none hover:text-white"
              ...
              <input
                ...
                className={`${
                  theme == "dark"
                    ...
                    : " bg-[#f5f1f0]"
                }  px-4 py-[6px] w-[100%] rounded-full focus:outline-none `}
        ...
        <section className=" ">
          {logedin ? (
            ...
            <section>
              ...
              <button className="  font-bold rounded-3xl border-[1px] px-3 sm:px-5 py-[4px] border-gray-400 hover:bg-[#39a84b] hover:border-[#e9ffed] hover:text-white">
                <Link to={"/auth/login"}>Login</Link>
              </button>
              <button className="  mx-2 font-bold rounded-3xl border-[1px] px-3 sm:px-5 py-[4px] border-gray-400 hover:bg-[#39a84b] hover:border-[#e9ffed] hover:text-white">
      ...
      <section className="sm:hidden m-4">
        ...
        >
          <input
            ...
            onChange={handlesearchchange}
            className={` ${
              theme == "dark" ? "border-none focus:outline-none" : "border-2"
            } border-2 px-4 py-1 w-[80%] rounded-full `}
            placeholder="search here"
          />
        </form>
      </section>
      ...
      <div className=" flex w-full p-2 sm:p-8">
        <div className=" w-[100%] sm:w-[72%] ">
          <div className=" flex justify-between items-center">
            <section
              className={` w-28 py-1 px-3  rounded-lg  ${
                theme == "dark"
                  ? " bg-[#0c131d] border-none shadow-[#0c131d] shadow-md"
                  : "bg-[#f5f1f0]"
              }`}
            >
              <p
          ...
          <div className="h-[82vh] overflow-y-auto m-1">
            {loading ? (
              ...
              <div className=" flex justify-center">
                <img src={image} alt="" className=" w-[45%] h-[45%]" />
              </div>
            ) : (
              data?.map((item, index) => {
                return (
        ...
        <div className="hidden sm:block w-[30%] p-5 overflow-y-auto h-[90vh] ">
          <div className="flex flex-col items-center">
            <section
              ...
              className={` flex justify-center cursor-pointer bg-green-600 shadow-lg ${
                theme == "dark" ? "" : "shadow-green-200"
              } text-white py-1 px-3 w-[70%] font-bold rounded-lg`}
            >
          ...
          <div>
            {log ? (
              <div
                className={` p-5 border-[1px] rounded-xl  flex justify-center items-center ${
                  theme == "dark"
                    ? "border-none bg-[#0c151d] shadow-md"
                    : "bg-[#f5f1f0] shadow-md"
                }`}
              >
                <h1 className=" font-bold text-green-600">
                  login to see questions you posted.
                </h1>
              </div>
            ) : loading2 ? (
              <div>
              ...
              >
                <h1 className=" font-semibold">
                  You hasn't post any question yet.
                </h1>
              </div>
            ) : (
